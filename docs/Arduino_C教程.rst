...
.. figure:: ./media/image-20250604194118614.png
   :alt: image-20250604194118614
...
.. figure:: ./media/image-20250604194229025.png
   :alt: image-20250604194229025
...
|                 | V1*1            |                 |                 |
+=================+=================+=================+=================+
| |image65|       | |image66|       | |image67|       | |image68|       |
+-----------------+-----------------+-----------------+-----------------+
...
1.
扫码下载\ |image105|\ 或者进入APP下载链接：\ http://8.210.52.206/Tank_Car.apk
...
4.
上传代码成功后，正确插好蓝牙模块，上电后，点击APP\ |image108|\ 图标，搜索到蓝牙，显示如下图。
...
5. 点击坦克车的图片\ |image115|\ 按钮，进入控制坦克车的界面
...
上面的项目，我们讲解了蓝牙接收到手机发送的信号并且在开发板的串口显示出来，比如我们按下\ |image118|\ ，然后我们就会接收到‘B’，当我们松开的时候又接收到‘S’。那接下来我们就要想一下了，我们可以利用接收到的信号去做一些事情吗，答案是肯定的，我们这里就利用手机发送的命令去打开或者关闭一个LED灯。看接线图，在D9脚接了一个LED。
...
连接上蓝牙，点击手机APP上\ |image120|\ 以控制LED。当您按住发送``B’‘时，LED将打开，而当您松开发送``S’’时，LED将关闭。
...
设置时，我们需要把一个图案转换成1组16个的16位数据，这里就需要用到一个取模软件,这个软件已放入资料文件夹中。使用时打开\ |image143|\ 图标，显示如下图。

|image144|

点击\ |image145|\ 这个图标新建图案，根据显示屏规格，设置宽度为16，高度为8，如下图。
...
设置参数设置，选择其他选项，设置如下图。设置完成点击\ |image151|\ 。
...
|image158|\ |image159|\ |image160| |image161|
...
.. figure:: ./media/img-20250610113842.png
   :alt: Img
...
.. figure:: ./media/img-20250610114323.png
   :alt: Img
...
+-----------------------+-----------------------+-----------------------+
| 按键：\ |image169|    | 键值：FF629D          | 状态：前进            |
+=======================+=======================+=======================+
| 按键：\ |image170|    | 键值：FFA857          | 状态：后退            |
+-----------------------+-----------------------+-----------------------+
| 按键：\ |image171|    | 键值：FF22DD          | 状态：左转            |
+-----------------------+-----------------------+-----------------------+
| 按键：\ |image172|    | 键值：FFC23D          | 状态：右转            |
+-----------------------+-----------------------+-----------------------+
| 按键：\ |image173|    | 键值：FF02FD          | 状态：停止            |
+-----------------------+-----------------------+-----------------------+
...
|                       |                       | 能：进入蓝牙控制界面  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image178|       |                       | 功能：断开蓝牙连接    |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image179|       | 控制字                | 功能：按下，          |
|                       | 符：按下：F；松开：S  | 小车前进；松开就停止  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image180|       | 控制字                | 功能：按下，          |
|                       | 符：按下：B；松开：S  | 小车后退；松开就停止  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image181|       | 控制字                | 功能：按下，小        |
|                       | 符：按下：L；松开：S  | 车左旋转；松开就停止  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image182|       | 控制字                | 功能：按下，小        |
|                       | 符：按下：R；松开：S  | 车右旋转；松开就停止  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image183|       | 控制字符：            | 功能：小              |
|                       | 点击发送：S           | 车停止，停止所有功能  |
+-----------------------+-----------------------+-----------------------+
| 按钮:|image184|       | 控制字符：            | 功                    |
|                       |                       | 能：点击一下开启手机  |
...
按下\ |image192|\ 按钮，小车前进；按下\ |image193|\ 按钮，小车后退；按下\ |image194|\ 按钮，小车左旋转；按下\ |image195|\ 按钮，小车右旋转；点击\ |image196|\ 按钮，小车停止；点击一下\ |image197|\ 按，开启手机重力感应控制，拿起手机从不同的方向移动手机，智能车会自动的移动，再点击一下\ |image198|\ 按钮，退出重力感应控制。
...
将驱动扩展板堆叠在UNO
R3板上，上传好代码，按照接线图接线，将拨码开关拨至ON端后，手机APP连接蓝牙成功后，我们就能用手机APP控制智能车运动了。我们可以通过按下对应按钮实现对应功能，通过停止钮来停止功能。点击一下\ |image200|\ 按，开启手机重力感应控制，拿起手机从不同的方向移动手机，智能车会自动的移动，再点击一下\ |image201|\ 按钮，退出重力感应控制。
...
.. |image29| image:: media/eb4e6d393edafbda78ae4cb3b58a961e.png
.. |image30| image:: media/a6dbf9a1d18d8849437f013dcaf2d4a6.png
.. |image31| image:: media/67417bd98f12bffd0352f76063e5abbd.png
.. |image32| image:: media/3dca1bdd1d1420c1d12b16cbf52fee00.png
.. |