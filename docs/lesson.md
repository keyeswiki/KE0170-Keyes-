...
4.上传代码成功后，连接蓝牙，上电后，蓝牙模块上LED闪烁。点击APP![](media/36b1f3e7cfca7e69178124d46abfa609.png)图标，搜索到蓝牙，显示如下图。
...
在keyes V4.0开发板上传代码成功，按照接线图接线，拨码开关拨打到右端上电后，看一下，我们的显示屏上是不是显示了一个笑脸。
